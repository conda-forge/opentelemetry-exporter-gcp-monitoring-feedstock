About opentelemetry-exporter-gcp-monitoring-feedstock
=====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-exporter-gcp-monitoring-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-exporter-gcp-monitoring-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-exporter-gcp-monitoring
# for installing globally
pixi global install opentelemetry-exporter-gcp-monitoring
```
...
It is possible to list all of the versions of `opentelemetry-exporter-gcp-monitoring` available on your platform:
...
```
pixi search opentelemetry-exporter-gcp-monitoring --channel conda-forge
```
